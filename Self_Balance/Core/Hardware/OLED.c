...
不能同时两个都同时取消注释！
在stm32cubemx中初始化时需要将SCL和SDA引脚的"user lable"分别设置为I2C2_SCL和I2C2_SDA。
*/
#define OLED_USE_HW_I2C	// 硬件I2C
//#define OLED_USE_SW_I2C	// 软件I2C

/*引脚定义，可在此处修改I2C通信引脚*/
#define OLED_SCL            I2C2_SCL_Pin // SCL
#define OLED_SDA            I2C2_SDA_Pin // SDA
#define OLED_SCL_GPIO_Port  I2C2_SCL_GPIO_Port
#define OLED_SDA_GPIO_Port  I2C2_SDA_GPIO_Port

/*STM32G474芯片的硬件I2C2: PA8 -- SCL; PC9 -- SDA */
...
void OLED_GPIO_Init(void)
{
	...
	GPIO_InitStruct.Pin = I2C2_SDA_Pin;                 // 设置引脚
 	HAL_GPIO_Init(I2C2_SDA_GPIO_Port, &GPIO_InitStruct);// 初始化GPIO
